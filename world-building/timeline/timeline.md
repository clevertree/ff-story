...
**Note on Dates:** Dates are listed in "Actual Time" (AT). References in "Post-Fry Time" (PF) are noted where applicable.
...
- **1971 - 202X:** **The Silent Theft.** The SBMs spread across the Far Side, harvesting heat and AETHER energy to build a massive harvester structure. Indigenous life is forced to flee.
- **202X (Early Year):** **The Cultural Zenith.** Global society experiences a surge of renewal, unaware that a secret Earth-based faction (The Technocratic Core) has remote control over the Far Side's new "species."
- **202X (Mid Year):** **The Revelation.** News of alien life on the Far Side of the Moon is finally leaked/discovered.
