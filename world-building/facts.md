...
- **Striders (The Wellsian Tripods):** Highly mobile multi-legged vehicles that appeared primarily in the After Time. These are piloted by **Gorgons** and constructed to navigate ruined urban environments.
...
- **The Gorgons:** Highly intelligent, metallic Fire-aligned Synodics that represent a different branch of evolution from the humanoid Synanthropes.
    ...
    - **Political Utility:** They are regarded as the primary "enemy" by human survivors. The Archivists (Core) exploit this by using Gorgons as scapegoats, intentionally provoking conflicts that only the Core can then "resolve" to maintain their savior narrative. 
...
- **Cradle Zero:** The original facility built within a vast, federally reserved forest in America. This was the headquarters where Dr. Aris Vane and the Core scientists developed the Vessels. Following the Moon Cataclysm, this site was abandoned and devastated, becoming the **Desert Base** and eventually the first **Fire City**. In **Chapter 16**, the Archivists launch their first major reclamation mission from **Cradle Prime** to return to **Cradle Zero**, extinguish its "fire," and convert it into a controlled outpost.
