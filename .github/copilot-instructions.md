...
- [x] **Location Disambiguation:** **Base Alpha** is deprecated. The terrestrial Core base is **Cradle Zero**. The enemy lunar base (and first contact site) is **Cradle Prime**.
