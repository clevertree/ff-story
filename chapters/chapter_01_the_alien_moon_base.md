...
2. **The First Leaks:** Amateur signal trackers break the news of the "Alien Moon Base" on the far side of the moon.
...
✅ **Historical Context:**
- **Alien Moon Base:** The common name used by media and leakers for what the Core calls "Base Alpha."
- **Monoliths:** Initial public perception of the machines; massive, ape-like, but still seen as "alien" rather than "industrial."
- **The First Strike:** The catalyst for the end of the old world order.

✅ **Tone:**
- Clinical, observational, documenting the slow dissolution of society.
- Emphasizes the length of time (years) rather than a sudden disaster.
