...
3. **Anton's Arrival:** Following the successful mission, General Ajax—who the museum claims was reincarnated to fulfill the Millennium Trajectory—relocates to the Cradle Zero base, bringing the Core's military and scientist community with him.
...
8. **The Legend of Rahu:** He visits a city museum and accesses official archives detailing the "Hero Rahu," the Vessel who supposedly fought the "Witch Maya" twice: once in Year 0 to destroy the Lunar Capacitor, and again in Year 1000 to prevent Earth's destruction.
9. **The Relic of the Moon:** Lem sees a replica of Rahu's sword in a museum; the exhibit claims he used it to deflect Maya's electric attacks and cut through her on the Moon. The **Lamenters** believe the original blade still carries the spirit of the Year 0 sacrifice.
10. **1000 Year Fallacy:** Lem sees a timeline indicating that the current year is 1015, with 1015 years since the Moon Cataclysm began (Year 0), and only 15 years since the Reclamation (reincarnation). The museum explains this duplicate history claiming Maya returned 1000 years later to finish what she started.
11. **The Failed Bloom:** In this narrative, the reincarnation of Rahu and Ajax ended a thousand years of alien occupation, and they are both still alive and leading the human race out of the darkness of the 1000 years of alien occupation.
12. **The Maya-Leaf Hunt:** Lem learns about a religious ritual that parents engage their children in - the **Maya-Leaf Hunt**. Parents hide lab-grown maple leaves (which do not grow naturally in the city or desert) for kids to find and burn. They are told the leaves are "Maya" and must be purged; rewards are given for the largest collection of burnt ash.
13. **The Lamenters (Vessel Religion):** Lem approaches a part of the museum explaining the "Vessel" belief held by 15% of the population. They view Rahu and Ajax as spiritual reincarnations of ancient holy spirits who died in Year 0. While the Core is secular, it permits the **Lunar Lament**—a monthly candlelit service where citizens mourning the moon's loss reject artificial power for natural flame.
14. **Unaligned Religion:** The museum stand concludes by stating that while most citizens see Vessels as advanced technology (85%), the 15% "Lamenter" minority is tolerated. Lem notes that all other indigenous religions are branded as 'tainted software' of the Occupation, including the dangerous 'Maya Cult'.
...
18. **The Paralysis Secret:** He remembers Rahu's paralysis after the aborted Lunar Reset—a detail kept from Rahu himself to ensure his continued obedience, as Rahu lacks Lem's persistence and cannot remember the event easily. He also is subjected to the 'Slow-burn' memory wipe proceedure which reinforces the Core's narrative in Rahu's memory. None of this is revealed in the Museum. 
19. **The Calculated Delay:** Lem wonders if this "Paralysis Secret" is why Rahu was kept off Mission 2, and why his "slow-burn" memory wipe takes significantly longer than any other Vessel's—a deliberate measure to ensure any lingering echoes of the betrayal are thoroughly erased.
20. TODO: Incorporate a religious or philosophical reflection from a local perspective.
21. TODO: Add technical exposition explaining the functional mechanics of the technology or structures involved.
22. TODO: Clarify the passage of time and situational shifts in the setting.
23. TODO: Reflect on the political landscape and world power reactions.
...
- **The Hive City:** A series of monitored habitations that promise safety through total surveillance and manufactured threats.
...
- **The Lamenters:** A minority (15%) who believe the Vessels are reincarnated holy spirits. They perform the **Lunar Lament**, a monthly candlelit ritual.
...
- **Lore Drop:** Ensure the details about the "mega-cities", Rahu's "slow-burn wipe", and the "Lamenter" rituals are treated as shocking discoveries for Lem.
...
- **Key Characters:** Anton Drexler and General Ajax appear as the faces of the Core's new order.
