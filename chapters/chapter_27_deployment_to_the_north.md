# Chapter 22: Deployment to the North

**Timeline:** Year 15 AT
**POV:** Lem
**Setting:** Desert Base Hangar → High Altitude → Northern Forest Landing Site
...
### Lem
- **Emotional/Psychological State:** Fascinated and repelled by the HUD. He feels the remote control "checking" his motor cortex, like a pilot testing a plane's controls.
- **Key Beats:**
    1. Experiencing the Mach 3+ traversal and the transition from desert to forest.
    2. Feeling the "HUD" and remote control influence for the first time.
    3. Seeing the impact sites and the "invading" pods.

---

## World-Building Integration

✅ **Hover Jet Technology:** High-speed, Synodic-derived transport.
✅ **Mission Interface:** Direct contact with operators and the visual HUD.
✅ **Gorgon Pods:** Their physical appearance and origin from the Moon fragments.
✅ **Atmospheric Contrast:** The difference in planetary conditions post-Fry.

---

## Notes & Spoilers

- **Internal Spoiler:** The Gorgon pods were tracked by the Core long before impact; the choice to send Lem *now* is a test of his physical abilities and loyalty.
