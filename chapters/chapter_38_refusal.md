...
2. **The Sermon of the Pentad:** Lem reaches the village center and finds Arlo standing on a raised wooden platform. Arlo is delivering a sermon about the **Wuxan** "Circle of Life" and the **Long Count** (Year 4,213). Based on stories from old man Azar, Arlo argues that history is a recurring technocratic trap. He explains that power always flows from a hidden "Core" and a secret priest class, whether they call themselves the Wizard of Oz, Aliens, or God. He tells the villagers that anyone can see this trap if they look for the hidden handlers.
3. **The Hidden Autocracy:** During the sermon, Arlo speaks of the "Scrubbing"—the period where the Core attempted to harmonize the records by deleting the story of the "Third Man." He quotes a fragment from the old world—"and now I just need your credit card number"—as proof that the ultimate goal of the "monsters" is always a mundane transaction of power and control. He looks directly at Lem, identifying him as the living anomaly that the **Wuxan** songs were meant to warn against.
...
11. **The Wuxan Law:** Arlo rejects the link, arguing that "forgetting" is a mercy of the soul. He retains the glass locket containing the **Invisible Grain**, keeping the "burdens of the past" within the village as the Ait-Aman continue their spiritual focus. He turns his back on Lem, returning to his villagers to discuss the day’s revelations.
12. **The Return:** Lem leaves the village and returns to the ridge. He informs Myrr and the Voidsmen crew that there will be no alliance. Arlo’s refusal to acknowledge his connection to Maya is total.
13. TODO: Describe the Voidsmen's reaction to the failed diplomacy.
...
15. **Mission Sideflash:** The team decides that they cannot simply wait for extraction or erasure. They vote to launch Mission Sideflash against Cradle Zero, transitioning from a survival strategy to a direct offensive.
