...
**Timeline:** Year 1022 (Year 22 AT - The Stabilization Era)
...
**Chapter Beats:**
1. **The Selective Welcome:** Arlo ignores the formal delegation and Cassia, focusing entirely on Kiran. Their embrace is the only warmth in an otherwise frigid and suspicious reception.
2. **The Smoldering Center:** A massive, smoldering pyre of timber and ash dominates the village square, casting a heavy gray haze over the meeting.
3. **The Ritual of the Recovered:** Arlo informs Kiran that the pyre contains the remains of victims from **Ait-Idar** and **Ait-Ignan**, villages recently "normalized" by the Core.
4. **The Automation of Grief:** Kiran suggests automating such rituals to avoid disease. Arlo reveals he led the ceremony himself, preserving the tradition of a thousand cycles.
5. **The Common Job, Divided Spirits:** Kiran admits he works in city "reclamation" (cremation). The contrast between automated disposal and sacred ritual is stark.
6. **Cassia’s Intervention:** Cassia pleads for surrender, warning about the "Maya Effect" label the Core has applied to Arlo's influence.
7. **The False Flag Revelation:** Cassia reveals the Core's "Remote Driving" protocol—they are hijacking Gorgons to stage a fake massacre.
...
**Lem's Record:**
- **The Witness of Two Worlds:** Lem notes the profound difference between "disposal" and "ritual." He realizes that Arlo's power comes from his willingness to touch the dirt and the dead himself.
- **The Analytical Dread:** Lem detects the remote signals Cassia mentioned. He confirms that the Gorgons approaching are being "driven" by human operators in the floating islands.

## World-Building Integration (13_PLUS)
✅ **The Maya Effect:** The Core's technical term for the psychological "infection" of spiritual or non-logical belief systems that resist stabilization.
✅ **Remote Driving:** The ability of the Core High Enclave to override the automated brain-cores of Synodic machines and operate them manualy from a distance.
✅ **The Thousand-Year Fallacy:** The discovery that the "Stabilization Era" has used artificial time-dilation or record-editing to make 22 years feel like a millennium to those within the Hive.
✅ **Wuxan Reincarnation:** A belief system centered on communal cremation as a necessary transition for the soul, directly conflicting with Core "Reclamation" efficiency.
