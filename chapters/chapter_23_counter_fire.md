...
**Setting:** The Dead Zone / Equatorial Frontier
...
2. **The Hovercraft Pursuit:** The team operates high-speed hovercrafts to outpace the psionic monoliths and other wild technologies that attempt to reclaim the zone.
3. **The Aetheric Buoys:** To deter the psionic wildlife, Lem and the team deploy buoys that emit "Repeating commands" to leave, along with digital interference and electroshock deterrents.
4. **The Metal Secret:** During the mission, Lem learns that the Metal Vessels are a hive mind; Vector can simultaneously see through and operate multiple bodies or detach a primary node for tactical independence.
5. **The Forest Sleeper:** While the mission proceeds smoothly, a Monolith suddenly appears at the desert's edge near a large forest, ripping trees from the ground as it rises from its resting place.
6. **The Obsidian Sledge:** Vector identifies that the buoys must have disturbed the entity. As the Monolith marches toward the beacons, the massive Core gunship *Obsidian Sledge* arrives to provide heavy fire support.
7. **The Rage of the Machine:** Vector orders an attack; the gunship strikes the Monolith with plasma cannons. Though staggered, the entity enters a rage and charges the *Obsidian Sledge*, heading directly toward Lem’s position.
