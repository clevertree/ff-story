...
2. Lem chooses to reintegrate at the Cradle to get answers from Cassia, but finds Anton Drexler instead.
3. Anton explains the failsafe device and justifies suppressing the truth of the Moon Cataclysm.
4. Anton claims "Utopian Cities" are already being populated thanks to Lem's efforts.
5. Lem asks if the new world requires the destruction of the old; Anton confirms it does.
6. Anton orders Lem to return to the White Forest to deliver a message to Myrr.
