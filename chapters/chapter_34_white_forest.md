...
5. **Retry:** He repeats the mission. Again, Vector oversees the reconstitution, his presence a constant reminder of the Core's surveillance. He expresses no frustration, only a clinical interest in why Lem's tactical response failed to predict the snake's attack.
6. **The Voidsman Vows:** In the deep silence of the retry, Lem reflects on the philosophical schism between the Voidsmen and the Core—the rejection of the "Programmed" for the "Programmer."
...
- **The Data-Point Existence:** Lem feels the shift from being a "Scholarship Student" to a "Tactical Asset," realizing that his value is now entirely measured in milliseconds.
- **The Forest’s Call:** His brief integration with the snake's network gives him a glimpse of a non-Core world that he finds both terrifying and beautiful.

**Vector (13_PLUS):**
- **The Perfect Machine:** He treats Lem’s death as a minor calibration error, highlighting the lack of empathy in the Hive's highest-ranking soldiers.

## World-Building Integration (13_PLUS)
✅ **Cloud-Piercer Trees (13_PLUS):**
- Biomechanical giants that harvest aetheric energy to power the Voidsmen's sanctuary.
- **The Void:** A signal-deadening zone that protects the forest from remote control.

✅ **Synodic Predator (The Serpent):**
- A guardian machine that uses copper heat-seeking tendrils to hunt unauthorized energy signatures.

✅ **Mochikomi (The Burden):**
- The cultural and spiritual practice of learning through repeated, conscious failure.

✅ **Tone (13_PLUS):**
- Isolated, high-tech, and mythic. The chapter emphasizes the hero’s inner rebellion against a heartless authority.
